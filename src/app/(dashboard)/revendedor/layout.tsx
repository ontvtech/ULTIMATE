...
const mockUser = {
  ...
  email: 'revendedor@saaswpp.ai',
  avatarUrl: null,
  status: 'ACTIVE',
  currentTenantId: 'tenant-reseller',
  tenants: [
    {
      tenantId: 'tenant-reseller',
      tenantName: 'Revenda Premium',
      tenantSlug: 'revenda-premium',
      tenantStatus: 'ACTIVE' as const,
      roleId: 'role-reseller',
      roleName: 'Revendedor',
      roleKey: 'REVENDEDOR' as const,
      isActive: true,
    },
  ],
  permissions: [
